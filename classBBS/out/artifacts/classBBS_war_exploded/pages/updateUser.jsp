...
<script type="text/javascript">
    ...
    function answerQuestion() {
        ...
        swal({
            title : "密保问题验证",
            text : "密保问题: " + question.value,
            type : "input",
            showCancelButton: true,
            closeOnConfirm: false,
            animation: "slide-from-top",
            inputPlaceholder: "请输入密保问题答案!"
        },
            function (inputValue) {
            if(inputValue == "") {
                swal.showInputError("请输入密保问题答案");
            }
            else {
                if (inputValue == answer.value)
                    window.location = "updatePassword.jsp";
                else
                    swal.showInputError("答案错误!");
            }
        }
        );
    }
    ...
    <div id="intro">
        <s:form name="myform" action="UpdateUser">
            <table id="userInfoTable" width="90%" class="table">
                ...
                <tr>
                    <th>密码</th>
                    <td id="password"><input type="button" onclick="answerQuestion()" value="修改密码"/></td>
                </tr>
                <tr>
                    <th>昵称</th>
